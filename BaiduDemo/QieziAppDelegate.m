...
#import "QieziAppDelegate.h"

#import "QieziViewController.h"

@implementation QieziAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.viewController = [[[QieziViewController alloc] initWithNibName:@"QieziViewController" bundle:nil] autorelease];
